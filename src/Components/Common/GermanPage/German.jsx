...
const German = () => {
  ...
  useEffect(() => {
    fetch(
      `${API_BASE}/api/language-page/online-german-language-course`
    )
      .then((res) => res.json())
      .then((data) => {
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div className="w-full grid grid-cols-1 h-[150px] md:h-[300px] lg:h-[400px] xl:h-[600px]">
          <div
            ...
            style={{
              backgroundImage: "url('/images/germanbanner.png')",
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <img
              ...
              alt="German Language"
              className="w-[200px] sm:w-[260px] h-[200px] sm:h-[260px] object-cover rounded-full"
            />
          </div>
