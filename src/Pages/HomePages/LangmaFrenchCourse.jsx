...
export default function LangmaFrenchCourse() {
  ...
  return (
    <div className="langma-page" id="top" style={{ '--announce-h': `${announceHeight}px` }}>
      <LanguageFaqSchema language="French" />
  ...
  * { min-width: 0; }
  ...
  `}</style>
      ...
      {/* FRENCH FOOTER */}
        ...
        <div className="footer-grid"><div className="footer-brand"><img src="https://www.langmainternational.com/images/ftrnlg.png" alt="Langma International" className="footer-logo" /><p>Learn French with structured language learning, practical communication, cultural activities and France-focused counselling.</p></div><div className="footer-col"><h4>Contact</h4><a href="tel:+919810117094">+91-98101-17094</a><a href="https://wa.me/919810117094" target="_blank" rel="noopener">Chat on WhatsApp</a></div><div className="footer-col"><h4>Legal</h4><a href="/privacy-policy">Privacy Policy</a><a href="/terms-and-conditions">Terms and Conditions</a></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Langma International Pvt. Ltd.</span><span>FRENCH LANGUAGE · {locationProfile.city.toUpperCase()}</span></div>
      </footer>
    </div>
  );
}
