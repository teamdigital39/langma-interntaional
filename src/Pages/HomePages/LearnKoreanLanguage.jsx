...
const TESTIMONIALS = [
  {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959740/WhatsApp_Video_2026-09-09_at_17.54.55_bvn4tx.mp4"
  },
  {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959739/WhatsApp_Video_2026-09-09_at_17.55.01_jydoha.mp4"
  },
  {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959737/WhatsApp_Video_2026-09-09_at_17.56.51_vqcplx.mp4"
  },
  {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959736/WhatsApp_Video_2026-09-09_at_17.57.14_py87hm.mp4"
  },
  {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959736/WhatsApp_Video_2026-09-09_at_17.57.39_eflvmy.mp4"
  },
      {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959735/WhatsApp_Video_2026-09-09_at_17.58.04_yajsbg.mp4"
  },
        {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959739/WhatsApp_Video_2026-09-09_at_17.55.18_pk1f6x.mp4"
  },
        {
    video: "https://res.cloudinary.com/dzv9zcrlz/video/upload/v1788959734/WhatsApp_Video_2026-09-09_at_17.59.04_zunh8r.mp4"
  },
];
...
const EXAM_BADGES = [
  { code: "TOPIK I", subtitle: "Levels 1–2, Foundation", ring: "#CD2E3A", accent: "#0F3F73", letter: "I" },
  { code: "TOPIK II", subtitle: "Levels 3–6, Advanced", ring: "#0F3F73", accent: "#CD2E3A", letter: "II" },
  { code: "EPS-TOPIK", subtitle: "Employment Korean", ring: "#D4AF37", accent: "#0F3F73", letter: "E" },
  { code: "KIIP", subtitle: "Integration Programme", ring: "#1A1A1A", accent: "#CD2E3A", letter: "K" },
  { code: "Sejong", subtitle: "Practical Korean", ring: "#0F3F73", accent: "#D4AF37", letter: "S" },
  { code: "University", subtitle: "Study Pathway", ring: "#CD2E3A", accent: "#0F3F73", letter: "U" }
];
...
const KOREAN_FORM_FIELDS = [
  { name: "name", label: "Name", type: "text", autoComplete: "name", placeholder: "Your name" },
  { name: "phone", label: "Phone", type: "tel", autoComplete: "tel", placeholder: "10-digit number", pattern: "[0-9]{10}" },
  { name: "email", label: "Email", type: "email", autoComplete: "email", placeholder: "Your email" },
];

const KOREAN_FORM_CONFIG = {
  language: "Korean",
  message: "Korean Language Course enquiry",
  type: "Korean Landing",
...
export default function LangmaKoreanCourse() {
  ...
  async function submitLead(form, phoneValue, { setError, setSubmitted, setBusy, setMessage }) {
    ...
    formData.set("language", KOREAN_FORM_CONFIG.language);
    formData.set("type", KOREAN_FORM_CONFIG.type);
    formData.set("service", KOREAN_FORM_CONFIG.service);
    if (!formData.get("message")) {
      formData.set("message", KOREAN_FORM_CONFIG.message);
    }
      ...
      try {
        const fallback = await fetch(`${API_BASE}/api/contact-lead`, {
          ...
          body: JSON.stringify({
            ...
            mobile: phoneValue,
            message: formData.get("message") || KOREAN_FORM_CONFIG.message,
            type: KOREAN_FORM_CONFIG.type,
  ...
  async function handleRequestSubmit(e) {
    ...
    setRequestFormMessage("");
    const typeMessages = {
      demo: "Interested in Learning Korean - Request Demo",
      study: "Interested in Study in Korea Program",
      work: "Interested in Work in Korea Pathway",
      ssw: "Interested in EPS (Skilled Worker) Program",
  ...
  return (
    <div className="langma-page" id="top" style={{ '--announce-h': `${announceHeight}px` }}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;500;600;700&family=Roboto:wght@400;500;700;900&display=swap');
  ...
  *{box-sizing:border-box; margin:0; padding:0;}
  ...
  h1,h2,h3{font-family:'Noto Sans KR', sans-serif; font-weight:700; letter-spacing:0; color:var(--ink);}
  * { min-width: 0; }
  ...
  .kr-header{background:rgba(251,252,255,.96); backdrop-filter:blur(10px); border-bottom:1px solid var(--line); position:fixed; top:var(--announce-h, 0px); left:0; right:0; width:100%; height:var(--header-h); z-index:80; box-shadow:0 4px 18px rgba(19,39,56,.08); transition:top .25s ease;}
  .kr-nav{min-height:74px; display:flex; align-items:center; justify-content:space-between; gap:24px;}
  .kr-brand{display:flex; align-items:center; text-decoration:none; transition:opacity .18s ease;}
  .kr-brand:hover{opacity:.82;}
  ...
  .kr-brand-fallback{font-family:'Roboto', sans-serif; font-weight:700; font-size:22.5px; color:var(--prussian); white-space:nowrap;}
  .kr-menu{display:flex; align-items:center; gap:18px; flex-wrap:wrap;}
  .kr-phone{display:flex; align-items:center; gap:9px; font-family:'Roboto', sans-serif; font-weight:700; font-size:16px; color:var(--prussian-deep); text-decoration:none; white-space:nowrap; transition:color .18s ease;}
  .kr-phone svg{flex-shrink:0; color:var(--rust);}
  .kr-phone:hover{color:var(--rust);}
  .kr-menu .kr-cta{background:var(--rust); color:#fff; padding:11px 18px; border-radius:var(--r-sm); font-size:14.5px; font-weight:700; text-decoration:none; transition:background .18s ease, transform .18s ease;}
  .kr-menu .kr-cta:hover{background:var(--rust-deep); transform:translateY(-1px);}
  ...
  .hero-photo{position:absolute; inset:0; background-image:linear-gradient(100deg, rgba(251,252,255,.985) 0%, rgba(251,252,255,.96) 48%, rgba(251,252,255,.78) 68%, rgba(251,252,255,.38) 100%), url('https://images.unsplash.com/photo-1517154421773-0529f29ea451?fm=jpg&q=80&w=1800&auto=format&fit=crop'); background-size:cover; background-position:center 65%; opacity:.03;}
  ...
  .stat{min-width:0; display:flex; flex-direction:column; align-items:flex-start; gap:6px; padding:0 12px; border-right:1px solid var(--line); transition:transform .2s ease;}
  ...
  .stat-text{display:flex; flex:1 1 auto; flex-direction:column; min-width:0;}
  .stat b{font-family:'Roboto', sans-serif; font-size:28px; display:block; color:var(--prussian); font-weight:700; white-space:nowrap;}
  .stat span{font-size:13px; color:var(--ink-mute); font-family:'Roboto', sans-serif; letter-spacing:.03em; line-height:1.3; overflow-wrap:anywhere;}

  /* Ticket visual — the hero's signature element: a boarding pass to Korea */
  ...
  .taegeuk-stamp{position:absolute; top:18px; right:18px; width:56px; height:56px; border:2px solid var(--rust); border-radius:8px; color:#fff; background:var(--rust); display:flex; align-items:center; justify-content:center; transform:rotate(-8deg); z-index:3; box-shadow:0 6px 16px rgba(190,30,45,.4); pointer-events:none;}
  .taegeuk-stamp span{font-family:'Noto Sans KR', sans-serif; font-weight:700; font-size:21.5px; line-height:1.05; letter-spacing:1px;}
  ...
  .skill-stamp .skill-native{width:54px; height:54px; border:2px solid var(--rust); border-radius:var(--r-sm); display:flex; align-items:center; justify-content:center; font-family:'Noto Sans KR', 'Roboto', sans-serif; font-weight:700; font-size:26px; color:var(--rust); margin-bottom:18px;}
  ...
  .kr-footer .wrap{position:relative; z-index:2;}
  ...
  .footer-brand .kr-motto{font-family:'Roboto',sans-serif; font-style:normal; font-weight:500; color:var(--gold-soft); font-size:15.5px; margin-bottom:15px;}
  ...
  @media (max-width: 980px){
    ...
    .hero-stats{grid-template-columns:repeat(4,minmax(0,1fr)); row-gap:18px;}
  ...
  @media (max-width: 720px){
    ...
    .hero-stats{grid-template-columns:repeat(2,minmax(0,1fr)); padding-top:16px;}
    .stat{gap:8px; padding:0 10px;}
    ...
    .kr-nav{min-height:66px; height:66px; padding-top:8px; padding-bottom:8px;}
    ...
    .kr-brand-text{width:150px; min-width:130px; height:38px;}
    .footer-grid{grid-template-columns:1fr 1fr; gap:28px;}
    .footer-brand{grid-column:1/-1;}
    .activity-content{padding:16px 16px 18px;}
    .taegeuk-stamp{top:12px; right:12px; width:48px; height:48px;}
    .taegeuk-stamp span{font-size:18px;}
    .ticket-route{padding-right:56px;}
  }
  @media (max-width: 480px){
    .sec-head h2{font-size:clamp(30px,8.5vw,40px); line-height:1.16;}
    .kr-nav{gap:12px;}
    .kr-brand-text{width:120px; min-width:96px; height:34px;}
    .kr-menu .kr-cta{padding:9px 13px; font-size:13px;}
    .hero-title{font-size:clamp(32px, 9.5vw, 46px);}
    .hero-sub{font-size:17.5px;}
    .stat b{font-size:20px; white-space:normal;}
    .stat span{font-size:10px; line-height:1.25;}
    ...
    .taegeuk-stamp{top:14px; right:50%; transform:translateX(50%) rotate(-8deg);}
  }
  `}</style>
      ...
      {showAnnouncement && (
        <div className="announcement-bar" ref={announceRef}>
          <div className="announcement-inner">
            <span className="announcement-text">🇰🇷 New Korean batch enrolling now — few seats available!</span>
            <a className="announcement-link" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20reserve%20a%20seat%20in%20the%20new%20Korean%20batch." target="_blank" rel="noopener">Reserve My Seat →</a>
          </div>
      ...
      <header className="kr-header">
        <div className="wrap kr-nav">
          <a className="kr-brand" href="#top" aria-label="Langma Korean Course">
            <span className="kr-brand-text">
              <img
                src="https://www.langmainternational.com/images/lngm2.png"
                alt="Langma International"
                className="kr-brand-logo"
              />
            </span>
          </a>
          <nav className="kr-menu" aria-label="Korean course navigation">
            <a className="kr-phone" href="tel:+919810117094" aria-label="Call Langma International at +91-98101-17094">
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div>
            <span className="hero-kicker">Korean Language Course · Online &amp; Offline Classes</span>
            <h1 className="hero-title">Your Gateway to Korea. Begins with <span className="heading-accent">Korean Language</span>.</h1>
            <p className="hero-sub">Langma helps students and professionals master Korean with expert trainers, small batch learning, TOPIK preparation, and practical support for study in Korea, work in Korea, and visa pathways. Choose flexible online or offline Korean classes in {locationProfile.city} and build real fluency for your future in Korea.</p>
            <div className="hero-actions">
              ...
              <a href="tel:+919810117094" className="btn btn-ghost">Talk to a Korean Counsellor</a>
            </div>
            <div className="hero-stats">
              ...
              <div className="stat">
                ...
                <div className="stat-text"><b>TOPIK 1–6</b><span>ALL TOPIK LEVELS</span></div>
              </div>
              <div className="stat">
            ...
            <div className="ticket-top">
              ...
              <form className="ticket-form" onSubmit={handleHeroSubmit}>
                <div className="ticket-form-row">
                  {KOREAN_FORM_FIELDS.map((field) => {
                    const fieldId = `h${field.name}`;
                    return (
                ...
                <input type="hidden" name="language" value={KOREAN_FORM_CONFIG.language} />
                <input type="hidden" name="message" value={KOREAN_FORM_CONFIG.message} />
                <input type="hidden" name="type" value={KOREAN_FORM_CONFIG.type} />
                <input type="hidden" name="service" value={KOREAN_FORM_CONFIG.service} />
        ...
        <div className="exam-strip">
          <div className="wrap">
            <div className="exam-head">
              <span className="kicker">TOPIK, EPS-TOPIK, KIIP &amp; Career Readiness</span>
              <h3>Prepare for the exam and the life you want in Korea.</h3>
            </div>
            <div className="exam-row reveal-group" role="list" aria-label="Korean language certification exams we prepare you for">
              {EXAM_BADGES.map((b, i) => {
                return (
        ...
        <div className="wrap">
          ...
          <div className="audience-grid reveal-group">
            ...
            <div className="audience-card">
              ...
              <p>Build strong Korean skills for university admissions, language programs, and long-term academic goals.</p>
            ...
            <div className="audience-card">
              ...
              <h3>Work in Korea</h3>
              <p>Prepare for workplace communication, interview confidence, and career pathways in Korea.</p>
            ...
            <div className="audience-card">
              ...
              <div className="audience-num">EPS</div>
              <h3>Employment Permit System</h3>
              <p>Build the Korean language foundation needed for sector-specific work, test preparation, and skilled migration pathways.</p>
              <button className="btn btn-primary btn-sm" onClick={() => openRequestPopup('ssw')} style={{marginTop: '14px', width: '100%', justifyContent: 'center', cursor: 'pointer'}}>Request EPS Program Info</button>
            </div>
            <div className="audience-card">
              ...
              <p>Learn practical Korean for travel, conversation, Korean media and cultural understanding.</p>
          ...
          <div className="section-cta-big">
            ...
            <p className="section-cta-subtext">Study in Korea, work in Korea, or build practical skills for everyday life.</p>
            <a className="btn btn-primary btn-large" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20help%20choosing%20the%20right%20Korean%20learning%20path." target="_blank" rel="noopener">
      ...
      <section id="skills">
        <div className="wrap">
          <div className="sec-head reveal">
            <h2>Build real Korean skills for everyday life and work.</h2>
            <p>Our Korean curriculum develops speaking, listening, reading, and writing together so you can communicate confidently in real situations, not just in a classroom.</p>
          </div>
          <div className="skills-grid reveal-group">
            <div className="skill-stamp">
              <div className="skill-native">말</div>
              <span className="skill-en">말하기 · Speaking</span>
            ...
            <div className="skill-stamp">
              <div className="skill-native">듣</div>
              <span className="skill-en">듣기 · Listening</span>
              <p>Native-accent audio and dialogues that train your ear for natural spoken Korean, not textbook Korean.</p>
            </div>
            <div className="skill-stamp">
              <div className="skill-native">읽</div>
              <span className="skill-en">읽기 · Reading</span>
              <p>From Hangul to everyday vocabulary, building comprehension script by script, level by level.</p>
            </div>
            <div className="skill-stamp">
              <div className="skill-native">쓰</div>
              <span className="skill-en">쓰기 · Writing</span>
              <p>Stroke order, sentence structure, and the shift from casual to formal speech, corrected and improved as you go.</p>
            </div>
          </div>
          <div className="section-cta-big">
            <h3 className="section-cta-heading">Build all four skills together</h3>
            <p className="section-cta-subtext">Speaking, listening, reading & writing—master Korean comprehensively with expert guidance.</p>
            <a className="btn btn-wa btn-large" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20book%20a%20free%20Korean%20demo%20class." target="_blank" rel="noopener">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 2c-5.5 0-9.96 4.46-9.96 9.96 0 1.76.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.5 0 9.96-4.46 9.96-9.96S17.54 2 12.04 2zm5.86 14.13c-.25.7-1.45 1.34-2 1.42-.51.08-1.15.11-1.86-.12-.43-.14-.98-.32-1.69-.63-2.97-1.28-4.9-4.27-5.05-4.47-.15-.2-1.22-1.62-1.22-3.09 0-1.47.77-2.19 1.05-2.49.27-.3.6-.37.8-.37.2 0 .4 0 .58.01.19.01.44-.07.68.53.25.6.85 2.08.92 2.23.07.15.12.32.02.52-.1.2-.15.32-.3.49-.15.17-.31.38-.44.51-.15.15-.3.31-.13.6.17.3.75 1.25 1.62 2.02 1.11.99 2.05 1.3 2.35 1.45.3.15.47.12.65-.07.18-.19.75-.87.95-1.17.2-.3.4-.25.66-.15.27.1 1.73.82 2.02.97.3.15.5.22.57.35.07.13.07.75-.18 1.45z"/></svg>
              Book Your Free Demo
            </a>
      ...
      <section className="journey" id="journey">
        <div className="taegeuk-grid-dark" aria-hidden="true"></div>
        <div className="wrap">
          <div className="sec-head reveal">
            <h2>Six Steps to Korean Language Fluency.</h2>
            <p>Every learner boards at TOPIK 1 and rides the same line through to TOPIK 5, and one stop beyond, each stage building the grammar, conversation and confidence you need for the next.</p>
          </div>
          ...
          <div className="rail-wrap">
            <div className="rail reveal-group">
              <div className="stop">
                ...
                <div className="stop-code">STOP 01 · TOPIK 1</div>
                <h3>Foundations</h3>
                <p>Hangul, basic grammar and greetings: everyday phrases you'll actually use from week one.</p>
              ...
              <div className="stop">
                ...
                <div className="stop-code">STOP 02 · TOPIK 2</div>
                <h3>Everyday Korean</h3>
                <p>Basic vocabulary and slower daily conversation, read and understood with growing confidence.</p>
                <span className="unlock-tag">Unlocks: EPS visa eligibility (EPS-TOPIK/TOPIK 2)</span>
              </div>
              <div className="stop">
                ...
                <div className="stop-code">STOP 03 · TOPIK 3</div>
              ...
              <div className="stop">
                ...
                <div className="stop-code">STOP 04 · TOPIK 4</div>
              ...
              <div className="stop">
                ...
                <div className="stop-code">STOP 05 · TOPIK 5</div>
              ...
              <div className="stop">
                ...
                <div className="stop-code">STOP 06 · BEYOND TOPIK 5</div>
                <h3>Business &amp; formal speech</h3>
      ...
      <section className="study-hours" id="study-hours">
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p>Approximate cumulative self-study hours to reach each TOPIK level from zero. Your actual pace depends on prior exposure, study method and hours committed per week.</p>
          </div>
          <div className="hours-chart">
            <div className="hours-row">
              <div className="hours-level">TOPIK 1</div>
              <div className="hours-track"><div className="hours-bar" style={{width: '17%'}}></div></div>
              <div className="hours-value">~50 hrs</div>
            </div>
            <div className="hours-row">
              <div className="hours-level">TOPIK 2</div>
              <div className="hours-track"><div className="hours-bar" style={{width: '33%'}}></div></div>
              <div className="hours-value">~50 hrs</div>
            </div>
            <div className="hours-row">
              <div className="hours-level">TOPIK 3</div>
              <div className="hours-track"><div className="hours-bar" style={{width: '50%'}}></div></div>
              <div className="hours-value">~50 hrs</div>
            </div>
            <div className="hours-row">
              <div className="hours-level">TOPIK 4</div>
      ...
      {/* COURSE CURRICULUM */}
      <section id="curriculum"><div className="wrap"><div className="sec-head reveal"><h2>Your Korean Language Learning Journey, Level by Level.</h2><p>The learning journey develops grammar, vocabulary, scripts, comprehension and communication together as you progress from TOPIK 1 towards advanced Korean.</p></div><div className="curriculum-grid reveal-group"><div className="curriculum-card"><div className="curriculum-level">Level 01 · TOPIK 1</div><h3>Foundations</h3><p>Build the base you need to start understanding and using Korean.</p><ul><li>Hangul &amp; pronunciation</li><li>Basic grammar &amp; sentence patterns</li><li>Greetings &amp; introductions</li><li>Everyday vocabulary</li><li>Basic vocabulary &amp; listening</li></ul></div><div className="curriculum-card"><div className="curriculum-level">Level 02 · TOPIK 2</div><h3>Everyday Korean</h3><p>Move from basic phrases into more independent everyday communication.</p><ul><li>Expanded grammar &amp; vocabulary</li><li>Daily-life conversations</li><li>vocabulary &amp; reading practice</li><li>Listening comprehension</li><li>TOPIK / EPS-TOPIK preparation</li></ul></div><div className="curriculum-card"><div className="curriculum-level">Level 03 · TOPIK 3</div><h3>Intermediate Bridge</h3><p>Develop longer conversations and wider real-world Korean.</p><ul><li>Intermediate grammar</li><li>Workplace vocabulary</li><li>Longer reading passages</li><li>Natural conversation practice</li><li>Exam-focused mock practice</li></ul></div><div className="curriculum-card"><div className="curriculum-level">Level 04 · TOPIK 4</div><h3>Business-Level Korean</h3><p>Build stronger comprehension and communication for professional environments.</p><ul><li>Advanced grammar &amp; vocabulary</li><li>News &amp; workplace Korean</li><li>Meetings &amp; professional scenarios</li><li>Formal communication</li><li>TOPIK TOPIK 4 preparation</li></ul></div><div className="curriculum-card"><div className="curriculum-level">Level 05 · TOPIK 5</div><h3>Advanced Mastery</h3><p>Handle complex written and spoken Korean with greater accuracy.</p><ul><li>Complex grammar structures</li><li>Advanced vocabulary &amp; vocabulary</li><li>Abstract &amp; formal Korean</li><li>High-level reading &amp; listening</li><li>TOPIK TOPIK 5 preparation</li></ul></div><div className="curriculum-card"><div className="curriculum-level">Beyond TOPIK 5</div><h3>Business &amp; formal speech</h3><p>Go beyond exam Korean into professional and high-context communication.</p><ul><li>formal speech &amp; honorific speech</li><li>Business etiquette</li><li>Professional conversations</li><li>Presentation &amp; meeting language</li><li>Executive communication practice</li></ul></div></div></div></section>
      ...
      {false && <section className="lang-facts" id="language">
        <div className="wrap">
          <div className="lang-inner">
            <div>
              <h2 style={{fontSize: 'clamp(30px,3.4vw,44px)', margin: '0 0 20px', lineHeight: '1.16'}}>Korean: more useful than most people expect.</h2>
              <div className="lang-copy">
                <p>Korean is spoken by more than 75 million people worldwide, one of the few major world languages where nearly every speaker lives across South Korea, North Korea and global Korean communities.</p>
                <p>It belongs to the Koreanic language family, a distinct language with its own elegant writing system, so learning Korean usually means different study habits than learning German or Spanish. There aren't many cognates to lean on. Instead, once Korean sentence structure clicks (verb at the end, particles doing the work English uses word order for), vocabulary starts building itself.</p>
                <p>South Korea is a global leader in technology, culture and innovation and a global leader in manufacturing, electronics and technology, which means learning Korean isn't just a classroom exercise, it's a career move, opening doors in engineering, IT, automotive and skilled-trade roles across the country.</p>
              </div>
            ...
            <div>
              <img className="lang-photo" src="/images/korean-hangul-feature.jpg" alt="Hangul lettering practice" loading="lazy" />
              <div className="fact-strip reveal-group">
                <div className="fact-box"><b>75M+</b><span>speakers worldwide</span></div>
                <div className="fact-box"><b>한글</b><span>a logical, purpose-built writing system</span></div>
                <div className="fact-box"><b>24</b><span>core Hangul letters to begin reading</span></div>
                <div className="fact-box"><b>Global</b><span>culture, technology and business reach</span></div>
              </div>
              <div className="lang-note">
                <h4>Good to know</h4>
                <p>Korean verbs often come at the end of a sentence, which feels different at first but becomes intuitive through conversation. <em style={{fontFamily: "'Roboto', sans-serif", fontStyle: 'normal', fontWeight: 700}}>Hangul</em> is beautifully logical, and familiar phrases become easier with every conversation.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="wrap">
          <div className="features-grid reveal-group">
            <div className="feature">
              ...
              <p>Experienced, well-trained instructors fluent in Korean ensure you get the highest quality instruction, not a script.</p>
            </div>
            <div className="feature">
            ...
            <div className="feature">
              ...
              <p>Exclusive support for the Employment Permit System visa, Engineer/Specialist roles, and in-demand IT and manufacturing jobs in Korea, right after your course.</p>
            </div>
            <div className="feature">
      ...
      <section className="modes" id="modes">
        <div className="wrap">
          ...
          <img className="modes-photo" src="https://res.cloudinary.com/dzv9zcrlz/image/upload/v1789022198/korean_classes_unjhwf.png" alt="Students in a Korean language course classroom listening to their instructor" loading="lazy" />
      ...
      <section className="testimonials" id="testimonials">
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p>Real stories from learners who have made their move to Korea. Watch how Langma transformed their Korean journey.</p>
          </div>
                ...
                {TESTIMONIALS.map((t, i) => (
                  <div className="testi-slide" key={i} style={{ width: `${testiWidthPct}%` }}>
                    <div className="testi-card">
                      <video className="testi-video-el" src={t.video} poster={getVideoPoster(t.video)} controls playsInline preload="none" aria-label="Langma Korean course student testimonial" />
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* WHAT YOU GET */}
      <section className="included" id="included"><div className="wrap"><div className="sec-head reveal"><h2>Everything included in your Korean course.</h2><p>Support is designed around both language development and the goal behind your Korean learning journey.</p></div><div className="included-grid reveal-group"><div className="included-item"><span className="tick">✓</span><span>Live instructor-led Korean classes</span></div><div className="included-item"><span className="tick">✓</span><span>TOPIK 1–6 structured learning pathway</span></div><div className="included-item"><span className="tick">✓</span><span>Speaking, listening, reading &amp; writing practice</span></div><div className="included-item"><span className="tick">✓</span><span>vocabulary and vocabulary development</span></div><div className="included-item"><span className="tick">✓</span><span>Korean exam preparation</span></div><div className="included-item"><span className="tick">✓</span><span>Mock tests &amp; progress assessment</span></div><div className="included-item"><span className="tick">✓</span><span>Cultural &amp; real-life communication practice</span></div><div className="included-item"><span className="tick">✓</span><span>Online, offline &amp; hybrid learning options</span></div><div className="included-item"><span className="tick">✓</span><span>Goal-based counselling for Korea pathways</span></div></div></div></section>

      {sectionFormCta}

      {/* EPS / SPECIALIST / STUDY PATHWAYS */}
        ...
        <div className="wrap">
          ...
          <div className="path-grid reveal-group">
            <div className="path-card">
              <div className="path-photo-wrap"><img className="path-photo" src="https://www.langmainternational.com/images/Skilled_Worker.jpeg?fm=jpg&q=80&w=1200&auto=format&fit=crop" alt="Factory workers on a production line, representing the EPS worker visa route" loading="lazy" /></div>
              ...
              <p style={{fontSize: '15.5px', color: 'rgba(255,255,255,.7)'}}>A fast-growing route into Korea's manufacturing, agriculture, fishery and construction sectors. Most fields ask for the EPS-TOPIK, plus a sector-specific skills test.</p>
              <ul>
            ...
            <div className="path-card">
              <div className="path-photo-wrap"><img className="path-photo" src="https://www.langmainternational.com/images/Engineers.jpeg?fm=jpg&q=80&w=1200&auto=format&fit=crop" alt="Seoul business district skyline, representing white-collar specialist roles" loading="lazy" /></div>
              <div className="path-icon">
              ...
              <p style={{fontSize: '15.5px', color: 'rgba(255,255,255,.7)'}}>Korea's most common professional work visa for IT, engineering, marketing and international-business roles. TOPIK Level 3–4 is typically required by many employers for this category.</p>
              <ul>
            ...
            <div className="path-card">
              <div className="path-photo-wrap"><img className="path-photo" src="https://res.cloudinary.com/dzv9zcrlz/image/upload/v1788960319/study_korea_ksb30j.jpg?fm=jpg&q=80&w=1200&auto=format&fit=crop" alt="Korean university campus building, representing the study-in-Korea route" loading="lazy" /></div>
              <div className="path-icon">
              ...
              <h3>Study in Korea</h3>
              <p style={{fontSize: '15.5px', color: 'rgba(255,255,255,.7)'}}>From short-term language schools to full degree programmes. Korean universities require TOPIK Level 3+ for undergraduate admission and Level 4+ for graduate programmes.</p>
              <ul>
      ...
      <section id="careers"><div className="wrap"><div className="sec-head reveal"><h2>Where can Korean take you?</h2><p>Korean can support multiple academic, professional and international pathways, depending on your qualifications, experience and target route.</p></div><div className="career-grid reveal-group"><div className="career-card"><h3>Career &amp; Work in Korea</h3><div className="career-tags"><span className="career-tag">Employment Permit System</span><span className="career-tag">IT &amp; Engineering</span><span className="career-tag">Manufacturing</span><span className="career-tag">Hospitality</span><span className="career-tag">Caregiving</span><span className="career-tag">International Business</span></div></div><div className="career-card"><h3>Study &amp; Professional Opportunities</h3><div className="career-tags"><span className="career-tag">Language Schools</span><span className="career-tag">Universities</span><span className="career-tag">Korean University Preparation</span><span className="career-tag">Korean MNCs</span><span className="career-tag">Translation</span><span className="career-tag">Business Korean</span></div></div></div></div></section>

      {sectionFormCta}

      {/* TOPIK VS EPS-TOPIK */}
      <section className="exam-compare" id="exam-guide"><div className="wrap"><div className="sec-head reveal"><h2>TOPIK or EPS-TOPIK: which one is right for you?</h2><p>The right assessment depends on your objective. A counsellor can help you identify the appropriate preparation route.</p></div><div className="compare-wrap"><table className="compare-table"><thead><tr><th>Exam</th><th>Best known for</th><th>Levels / format</th><th>Useful for</th></tr></thead><tbody><tr><td>TOPIK</td><td>General Korean proficiency</td><td>TOPIK 1–6</td><td>Language proficiency, study and employment requirements where accepted</td></tr><tr><td>EPS-TOPIK</td><td>Practical Korean communication</td><td>Basic-level assessment</td><td>Employment Permit System-related Korean requirements where applicable</td></tr><tr><td>BKT</td><td>Business Korean</td><td>Business communication assessment</td><td>Professional and corporate Korean contexts</td></tr><tr><td>Korean University</td><td>University admissions</td><td>Admission examination</td><td>International students applying to Korean higher-education programmes where required</td></tr></tbody></table></div></div></section>

      {sectionFormCta}

        {/* UPCOMING BATCHES */}
      <section className="batches" id="batches"><div className="wrap"><div className="sec-head reveal"><h2>Find a batch that fits your schedule.</h2><p>We offer online, classroom and hybrid options. Ask us for the latest batch start dates, timings and course fee details.</p></div><div className="batch-grid reveal-group"><div className="batch-card"><div className="batch-tag">Online</div><h3>Live Online Batch</h3><div className="batch-meta"><div><b>Level</b><span>TOPIK 1 / 2 / 3 / 4 / 5 / 6</span></div><div><b>Format</b><span>Instructor-led</span></div><div><b>Timings</b><span>Ask for current schedule</span></div></div><a className="btn btn-primary" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20the%20latest%20Korean%20online%20batch%20details." target="_blank" rel="noopener">Get Online Batch Details →</a></div><div className="batch-card"><div className="batch-tag">{locationProfile.centre}</div><h3>Classroom Batch</h3><div className="batch-meta"><div><b>Location</b><span>{locationProfile.area}</span></div><div><b>Format</b><span>Face-to-face</span></div><div><b>Timings</b><span>Ask for current schedule</span></div></div><a className="btn btn-primary" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20the%20latest%20Korean%20classroom%20batch%20details." target="_blank" rel="noopener">Get Classroom Details →</a></div><div className="batch-card"><div className="batch-tag">Flexible</div><h3>Hybrid Batch</h3><div className="batch-meta"><div><b>Format</b><span>Online + classroom</span></div><div><b>Level</b><span>Based on availability</span></div><div><b>Timings</b><span>Ask for current schedule</span></div></div><a className="btn btn-primary" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20the%20latest%20Korean%20hybrid%20batch%20details." target="_blank" rel="noopener">Get Hybrid Details →</a></div></div><p className="batch-note">Course fees, schedules and batch availability may vary. Contact Langma International for the latest.rent course options.</p><div className="trust-badges"><span>✓ Free demo before you enrol</span><span>✓ Flexible batch switching</span><span>✓ Certified native-level trainers</span><span>✓ Visa &amp; placement support included</span></div></div></section>
      ...
      <section id="faq">
        <div className="wrap">
          <div className="sec-head reveal">
            <h2>Common questions about our Korean language course.</h2>
          </div>
          <div className="faq-list">
            <details className="faq-item">
              <summary>Do I need any prior knowledge of Korean to join?</summary>
              <p className="faq-a">No, most of our learners start at TOPIK 1 with zero Korean. Classes are structured so complete beginners build confidence, and Hangul, from the very first session.</p>
            </details>
            <details className="faq-item">
              <summary>Do I really need to learn all three writing systems?</summary>
              <p className="faq-a">Yes, eventually, but not all at once. You'll be comfortable in Hangul within the first few weeks; vocabulary is introduced gradually and cumulatively from TOPIK 1 through TOPIK 5, so it never feels like a wall.</p>
            </details>
            <details className="faq-item">
              <summary>How long does it take to become conversational?</summary>
              <p className="faq-a">Most learners feel comfortable with everyday conversation by the end of TOPIK 2–TOPIK 3, usually within a few months of consistent classes, depending on how many hours a week you can commit.</p>
            </details>
            <details className="faq-item">
              <summary>Can I also prepare for TOPIK, EPS-TOPIK or BKT?</summary>
              <p className="faq-a">Yes, once you're at the right level, we offer focused certificate preparation for TOPIK, EPS-TOPIK, KIIP, Sejong and BKT alongside the regular course, for anyone who needs a specific score for a visa, job or university application.</p>
            </details>
            <details className="faq-item">
            ...
            <details className="faq-item"><summary>Can I start Korean from zero?</summary><p className="faq-a">Yes. The pathway begins at TOPIK 1, and the programme is structured for learners with no prior Korean knowledge as well as learners joining at a higher level.</p></details>
            <details className="faq-item"><summary>How do I know which level I should join?</summary><p className="faq-a">A counsellor can help identify the appropriate starting point based on your previous Korean study, current ability and objective.</p></details>
            <details className="faq-item"><summary>Do you offer a free demo class?</summary><p className="faq-a">You can request a Korean demo or speak with a counsellor to understand the teaching format, level and current batch options.</p></details>
            <details className="faq-item"><summary>Can you help me choose a Korean exam?</summary><p className="faq-a">Yes. Counselling can help you identify whether TOPIK, EPS-TOPIK, BKT, Korean University or another assessment is relevant to your intended study or career pathway.</p></details>
            <details className="faq-item"><summary>Do you provide Korea career or visa guidance?</summary><p className="faq-a">Korea pathway support is available for the routes described on this page, including EPS, Engineer/Specialist and Study in Korea pathways. Exact eligibility and immigration decisions depend on the applicable requirements.</p></details>
      ...
      {/* STUDENT ACTIVITIES / KOREA CONNECTIONS */}
      <section className="activities" id="activities">
        <div className="taegeuk-grid-dark" aria-hidden="true"></div>
        <div className="wrap">
          <div className="sec-head reveal">
            <div className="activity-eyebrow" style={{fontFamily: "'Roboto', sans-serif", fontSize: '11px', letterSpacing: '.14em', color: 'var(--gold-soft)', textTransform: 'uppercase', marginBottom: '10px'}}>Activities &amp; Korea Experience</div>
            <h2>Learn. Experience. Connect.</h2>
            <p>Learning Korean at Langma goes beyond classroom lessons. Build confidence through interactive activities, cultural experiences and real-life Korean practice.</p>
          </div>
      ...
      {/* FINAL CTA */}
      <section className="final-cta" id="start"><div className="taegeuk-grid-dark" aria-hidden="true"></div><div className="wrap"><span className="kicker">Your Korean journey starts here</span><h2>Don't just learn Korean. Learn where it can take you.</h2><p>Get the current course fee, batch timings, learning mode and recommended level, without committing to a course first.</p><div className="final-cta-actions"><a className="btn btn-wa" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20the%20Korean%20course%20fee%20and%20batch%20details." target="_blank" rel="noopener">Get Course Details on WhatsApp →</a><a className="btn btn-ghost" href="tel:+919810117094">Talk to a Korean Counsellor</a></div><div className="microcopy">No price displayed here. Ask us for the current course options, fees &amp; batch availability.</div></div></section>
            ...
            <div className="enroll-card">
              ...
              <form id="enrollForm" onSubmit={handleSubmit}>
                {KOREAN_FORM_FIELDS.map((field) => {
                  ...
                  return (
                    <div className="form-row" key={field.name}>
                      <label htmlFor={fieldId}>{field.name === "name" ? "Full Name" : field.name === "phone" ? "Phone Number" : field.label}</label>
                      <input
                        {...field}
                        id={fieldId}
                        placeholder={field.name === "phone" ? "10-digit mobile number" : field.placeholder}
                        required
                        ref={field.name === "phone" ? phoneRef : undefined}
                        aria-invalid={field.name === "phone" ? phoneError : undefined}
                        aria-describedby={field.name === "phone" && phoneError ? "fphone-error" : undefined}
                        onChange={field.name === "phone" ? () => setPhoneError(false) : undefined}
                        style={field.name === "phone" && phoneError ? { outline: '2px solid #E4574C' } : undefined}
                      />
                      {field.name === "phone" && phoneError && <span id="fphone-error" className="field-error" role="alert">Enter a valid 10-digit phone number</span>}
                    </div>
                  );
                })}
                <input type="hidden" name="language" value={KOREAN_FORM_CONFIG.language} />
              ...
              <div className="form-alt">
                ...
                <a href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20enroll%20for%20the%20Korean%20course." target="_blank" rel="noopener" style={{fontSize: '14.5px', fontWeight: '600', color: 'var(--gold-soft)', textDecoration: 'underline'}}>Message us on WhatsApp →</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* KOREAN FOOTER */}
        ...
        <div className="wrap">
          <div className="footer-grid">
            ...
            <br /><div className="kr-motto">Learn Korean. Understand Korea. Build Your Future.</div><p>Learn Korean with structured TOPIK 1–6 learning, practical communication, cultural activities and Korea-focused counselling.</p></div>
            <div className="footer-col"><h4>Learn</h4><a href="#course-details">Korean Course</a><a href="#skills">What You Learn</a><a href="#methodology">Teaching Method</a><a href="#batches">Batches</a></div>
            <div className="footer-col"><h4>Korea</h4><a href="#activities">Student Activities</a><a href="#pathways">Korea Pathways</a><a href="#careers">Career Opportunities</a><a href="#exam-guide">TOPIK / EPS-TOPIK / BKT</a></div>
          ...
          <div className="footer-bottom"><span>© {new Date().getFullYear()} Langma International Pvt. Ltd.</span><span>KOREAN LANGUAGE · {locationProfile.city.toUpperCase()}</span></div>
        </div>
      </footer>
      {/* FLOATING CALL */}
      ...
      {showRequestPopup && (
        <div style={{position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999}} onClick={closeRequestPopup}>
          <div style={{background: '#fbf8f1', borderRadius: '16px', padding: '40px 32px', maxWidth: '420px', width: '90%', boxShadow: '0 28px 60px rgba(0,0,0,0.2)', animation: 'slideUp 0.3s ease'}} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={{fontSize: '14px', color: '#514840', marginBottom: '24px'}}>We'll match you with the perfect Korean learning path</p>
      ...
      {/* FLOATING WHATSAPP */}
      <a href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20know%20more%20about%20the%20Korean%20course." target="_blank" rel="noopener" className="wa-float" id="waFloat" aria-label="Chat on WhatsApp">
      ...
      <div className="mobile-cta-bar" aria-label="Quick contact buttons">
        ...
        <div className="mobile-cta-bar-actions">
          <a className="mobile-cta-bar-wa" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20know%20more%20about%20the%20Korean%20course." target="_blank" rel="noopener" aria-label="Chat with Langma on WhatsApp">
