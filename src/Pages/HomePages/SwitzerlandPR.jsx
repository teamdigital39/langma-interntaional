  ...
  return (
    <div className="sw-page">
      ...
      <style>{`
        ...
        .sw-page .eyebrow::before { content:""; width:34px; height:1px; background:#4EC7B8; display:inline-block; flex-shrink:0; }
        .sw-page .eyebrow.center { justify-content:center; }
        .sw-page .eyebrow.light { color:#4EC7B8; }
        .sw-page .eyebrow.light::before { background:#4EC7B8; }
        ...
        .sw-page .section-head p { color:#0E1F3D; font-size:17px; }
        .sw-page .section-head.light h2 { color:#F7FAFC; }
        ...
        .sw-page .btn-primary { background:#4EC7B8; color:#0E1F3D; }
        .sw-page .btn-primary:hover { background:#4EC7B8; transform:translateY(-2px); box-shadow:0 14px 30px rgba(47,199,161,.28); }
        .sw-page .btn-ghost { background:transparent; color:#F7FAFC; border:1px solid rgba(247,250,252,.45); }
        .sw-page .btn-ghost:hover { border-color:#4EC7B8; color:#4EC7B8; }
        .sw-page .btn-dark { background:#0E1F3D; color:#F7FAFC; }
        .sw-page .btn-dark:hover { background:#006064; transform:translateY(-2px); }
        ...
        .sw-page .hero h1 { font-size:clamp(38px,5vw,66px); color:#F7FAFC; margin-bottom:26px; font-weight:600; line-height:1.08; }
        .sw-page .hero h1 em { font-style:italic; color:#4EC7B8; font-weight:500; }
        .sw-page .hero .lead { font-size:17.5px; color:rgba(247,250,252,.82); max-width:560px; margin-bottom:38px; font-weight:300; line-height:1.72; }
        .sw-page .hero-cta { display:flex; gap:16px; flex-wrap:wrap; margin-bottom:48px; }
        .sw-page .hero-badges { display:flex; gap:36px; flex-wrap:wrap; border-top:1px solid rgba(247,250,252,.18); padding-top:28px; }
        .sw-page .hero-badge .num { font-family:'Cormorant Garamond',serif; font-size:28px; color:#4EC7B8; font-weight:600; line-height:1; }
        .sw-page .hero-badge .lbl { font-size:11.5px; letter-spacing:.6px; color:rgba(247,250,252,.68); margin-top:6px; }
        ...
        .sw-page .hero-img-frame::before { content:""; position:absolute; inset:0; background:linear-gradient(to top,rgba(14,31,61,.42) 0%,transparent 55%); z-index:1; border-radius:12px; pointer-events:none; }
        ...
        .sw-page .scroll-hint .line { width:1px; height:38px; background:linear-gradient(#4EC7B8,transparent); animation:sw-drop 2s cubic-bezier(.22,.61,.36,1) infinite; }
        ...
        /* Stats Bar */
        .sw-page .stats-bar { background:#0E1F3D; color:#F7FAFC; }
        ...
        .sw-page .stat-cell .v { font-family:'Cormorant Garamond',serif; font-size:42px; font-weight:600; color:#4EC7B8; line-height:1; margin-bottom:12px; }
        .sw-page .stat-cell .k { font-size:13px; letter-spacing:.5px; color:rgba(247,250,252,.78); }

        /* About */
        .sw-page .about { background:#F7FAFC; }
        ...
        .sw-page .about-copy p { color:#0E1F3D; margin-bottom:18px; font-size:16.5px; }
        .sw-page .about-media { position:relative; height:560px; border-radius:4px; overflow:hidden; box-shadow:0 30px 70px rgba(14,31,61,.18); }
        ...
        .sw-page .fact .ff { font-family:'Cormorant Garamond',serif; font-size:30px; color:#0E1F3D; font-weight:600; }
        .sw-page .fact .fl { font-size:12.5px; color:#0E1F3D; letter-spacing:.4px; margin-top:6px; }

        /* Living */
        .sw-page .living { background:#E8F4F2; }
        .sw-page .living-grid { display:grid; grid-template-columns:1fr 1.1fr; gap:64px; align-items:center; }
        .sw-page .living-media { position:relative; height:520px; border-radius:4px; overflow:hidden; box-shadow:0 30px 70px rgba(14,31,61,.18); }
        ...
        .sw-page .living-tag { border:1px solid #E5E5E5; border-radius:40px; padding:8px 18px; font-size:13px; color:#0E1F3D; background:#fff; }

        /* Why */
        .sw-page .why { background:#F7FAFC; }
        .sw-page .why-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:1px; background:#2E7D7B; border:1px solid #2E7D7B; border-radius:4px; overflow:hidden; }
        .sw-page .why-card { background:#F7FAFC; padding:42px 34px; transition:background .3s; }
        .sw-page .why-card:hover { background:#fff; }
        .sw-page .why-card .ic { width:46px; height:46px; border:1px solid #4EC7B8; border-radius:50%; display:flex; align-items:center; justify-content:center; color:#006064; font-family:'Cormorant Garamond',serif; font-size:21px; margin-bottom:20px; }
        .sw-page .why-card h3 { font-size:24px; margin-bottom:10px; }
        .sw-page .why-card p { color:#0E1F3D; font-size:15px; }

        /* Programme */
        .sw-page .prog { background:#0E1F3D; color:#F7FAFC; }
        ...
        .sw-page .prog-card:hover { border-color:#4EC7B8; transform:translateY(-6px); }
        .sw-page .prog-card .no { font-family:'Cormorant Garamond',serif; font-size:18px; color:#4EC7B8; border-bottom:1px solid rgba(247,250,252,.16); padding-bottom:14px; margin-bottom:18px; letter-spacing:1.5px; text-transform:uppercase; }
        .sw-page .prog-card h3 { color:#F7FAFC; font-size:25px; margin-bottom:12px; }
        .sw-page .prog-card p { color:rgba(247,250,252,.74); font-size:15px; }

        /* Benefits */
        .sw-page .benefits { background:#F7FAFC; }
        ...
        .sw-page .ben-card::before { content:""; position:absolute; top:0; left:0; width:3px; height:0; background:#4EC7B8; transition:height .4s cubic-bezier(.22,.61,.36,1); }
        .sw-page .ben-card:hover { box-shadow:0 18px 50px rgba(14,31,61,.08); transform:translateY(-4px); }
        .sw-page .ben-card:hover::before { height:100%; }
        .sw-page .ben-card .mk { font-family:'Cormorant Garamond',serif; font-size:22px; color:#006064; letter-spacing:1px; margin-bottom:16px; }
        .sw-page .ben-card h3 { font-size:23px; margin-bottom:10px; }
        .sw-page .ben-card p { color:#0E1F3D; font-size:15px; }

        /* Finance / Eligibility */
        .sw-page .finance { background:#E8F4F2; }
        .sw-page .fin-table { background:#fff; border:1px solid rgba(47,199,161,.25); border-radius:4px; overflow:hidden; box-shadow:0 18px 50px rgba(14,31,61,.08); }
        ...
        .sw-page .fin-row.head { background:#0E1F3D; }
        ...
        .sw-page .fc.label { font-weight:600; color:#0E1F3D; }
        .sw-page .fc.fig { font-family:'Cormorant Garamond',serif; font-size:26px; color:#006064; font-weight:600; }
        .sw-page .fin-note { margin-top:24px; font-size:13.5px; color:#0E1F3D; text-align:center; font-style:italic; }

        /* Family */
        .sw-page .family-sec { background:#F7FAFC; }
        .sw-page .fam-grid { display:grid; grid-template-columns:1fr 1fr; gap:60px; align-items:center; }
        .sw-page .fam-media { height:520px; border-radius:4px; overflow:hidden; box-shadow:0 30px 70px rgba(14,31,61,.18); position:relative; }
        ...
        .sw-page .fam-list .fi { flex:0 0 42px; height:42px; border-radius:50%; background:#0E1F3D; color:#4EC7B8; display:flex; align-items:center; justify-content:center; font-family:'Cormorant Garamond',serif; font-size:19px; }
        .sw-page .fam-list h4 { font-size:21px; margin-bottom:2px; }
        .sw-page .fam-list p { color:#0E1F3D; font-size:14.5px; }

        /* Process */
        .sw-page .process { background:#0E1F3D; color:#F7FAFC; }
        ...
        .sw-page .tl-item .dot { position:absolute; left:0; top:0; width:64px; height:64px; border-radius:50%; border:1px solid #4EC7B8; background:#0E1F3D; display:flex; align-items:center; justify-content:center; font-family:'Cormorant Garamond',serif; font-size:24px; color:#4EC7B8; }
        .sw-page .tl-item h3 { color:#F7FAFC; font-size:25px; margin-bottom:6px; }
        .sw-page .tl-item p { color:rgba(247,250,252,.72); font-size:15px; max-width:620px; }
        .sw-page .tl-time { display:inline-block; margin-top:10px; font-family:'Inter',sans-serif; font-size:12px; letter-spacing:1.5px; text-transform:uppercase; color:#4EC7B8; font-weight:600; }

        /* Life */
        .sw-page .life { background:#F7FAFC; }
        .sw-page .life-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:24px; margin-bottom:48px; }
        .sw-page .life-card { position:relative; height:420px; border-radius:4px; overflow:hidden; box-shadow:0 18px 50px rgba(14,31,61,.08); }
        .sw-page .life-card img { transition:transform .8s cubic-bezier(.22,.61,.36,1); }
        .sw-page .life-card:hover img { transform:scale(1.06); }
        .sw-page .life-card .ov { position:absolute; inset:0; background:linear-gradient(to top,rgba(14,31,61,.88) 0%,rgba(14,31,61,.18) 55%,transparent 100%); z-index:1; }
        .sw-page .life-card .cap { position:absolute; left:0; right:0; bottom:0; z-index:2; padding:30px 28px; }
        .sw-page .life-card .cap h3 { color:#F7FAFC; font-size:27px; margin-bottom:6px; }
        .sw-page .life-strip { display:flex; flex-wrap:wrap; gap:14px; justify-content:center; margin-top:48px; }
        .sw-page .life-tag { border:1px solid #E5E5E5; border-radius:40px; padding:10px 22px; font-size:13.5px; color:#0E1F3D; background:#fff; }

        /* Langma */
        .sw-page .langma { background:#0E1F3D; color:#F7FAFC; }
        .sw-page .langma-grid { display:grid; grid-template-columns:1fr 1.1fr; gap:64px; align-items:center; }
        .sw-page .langma h2 { color:#F7FAFC; font-size:clamp(32px,4.4vw,52px); margin-bottom:20px; }
        .sw-page .lg-list { display:grid; grid-template-columns:1fr 1fr; gap:30px 36px; }
        .sw-page .lg-item h4 { color:#4EC7B8; font-size:22px; margin-bottom:6px; }
        .sw-page .lg-item p { color:rgba(247,250,252,.72); font-size:14.5px; }

        /* FAQ */
        .sw-page .faq { background:#F7FAFC; }
        .sw-page .faq-wrap { max-width:880px; margin:0 auto; }
        .sw-page .faq-item { border-bottom:1px solid #E5E5E5; }
        .sw-page .faq-q { width:100%; text-align:left; background:none; border:none; cursor:pointer; padding:28px 0; display:flex; justify-content:space-between; align-items:center; gap:24px; font-family:'Cormorant Garamond',serif; font-size:22px; color:#0E1F3D; font-weight:600; }
        .sw-page .faq-q .pm { flex:0 0 30px; height:30px; border:1px solid #4EC7B8; border-radius:50%; display:flex; align-items:center; justify-content:center; color:#006064; font-family:'Inter',sans-serif; font-size:18px; transition:all .3s; }
        .sw-page .faq-item.open .pm { background:#4EC7B8; color:#0E1F3D; transform:rotate(45deg); }
        .sw-page .faq-a { max-height:0; overflow:hidden; transition:max-height .4s cubic-bezier(.22,.61,.36,1); }
        .sw-page .faq-a p { padding:0 0 28px; color:#0E1F3D; font-size:16px; max-width:760px; }

        /* Lead form */
        .sw-page .lead-sec { background:#0E1F3D; color:#F7FAFC; }
        .sw-page .lead-grid { display:grid; grid-template-columns:1fr 1.1fr; gap:64px; align-items:start; }
        .sw-page .lead-copy h2 { color:#F7FAFC; font-size:clamp(32px,4.2vw,50px); margin-bottom:20px; }
        ...
        .sw-page .lead-assure li::before { content:"✓"; color:#4EC7B8; font-weight:700; }
        .sw-page .form-card { background:#F7FAFC; border-radius:4px; padding:42px; box-shadow:0 30px 70px rgba(14,31,61,.18); }
        .sw-page .form-card h3 { font-size:27px; margin-bottom:6px; }
        .sw-page .form-card .fsub { color:#0E1F3D; font-size:14.5px; margin-bottom:26px; }
        .sw-page .frow { display:grid; grid-template-columns:1fr 1fr; gap:16px; }
        .sw-page .field { margin-bottom:16px; }
        .sw-page .field label { display:block; font-size:12px; letter-spacing:.5px; text-transform:uppercase; color:#0E1F3D; font-weight:600; margin-bottom:7px; }
        .sw-page .field input,.sw-page .field select { width:100%; padding:13px 15px; border:1px solid #E5E5E5; border-radius:4px; font-family:'Inter',sans-serif; font-size:15px; background:#fff; color:#0E1F3D; transition:border-color .25s; }
        .sw-page .field input:focus,.sw-page .field select:focus { outline:none; border-color:#4EC7B8; box-shadow:0 0 0 3px rgba(47,199,161,.15); }
        .sw-page .form-card .btn { width:100%; justify-content:center; margin-top:6px; }
        .sw-page .form-card .disc { font-size:12px; color:#0E1F3D; margin-top:14px; text-align:center; }
        .sw-page .success { display:none; background:rgba(47,199,161,.12); border:1px solid #4EC7B8; border-radius:4px; padding:16px; color:#006064; font-size:14.5px; text-align:center; margin-top:16px; }
        .sw-page .success.show { display:block; }

        /* Office */
        .sw-page .office { background:#E8F4F2; }
        ...
        .sw-page .office-copy p { color:#0E1F3D; font-size:16.5px; margin-bottom:26px; }
        ...
        .sw-page .office-points .oi { flex:0 0 38px; height:38px; border-radius:50%; border:1px solid #4EC7B8; color:#006064; display:flex; align-items:center; justify-content:center; font-family:'Cormorant Garamond',serif; font-size:18px; }
        .sw-page .office-points h4 { font-size:19px; margin-bottom:1px; }
        .sw-page .office-points p { font-size:14px; margin:0; color:#0E1F3D; }
        .sw-page .office-form { background:#fff; border:1px solid #E5E5E5; border-radius:4px; padding:40px; box-shadow:0 18px 50px rgba(14,31,61,.08); }
        .sw-page .office-form h3 { font-size:25px; margin-bottom:22px; }

        /* Footer */
        .sw-page .foot { background:#0E1F3D; color:rgba(247,250,252,.7); padding:74px 0 32px; }
        .sw-page .foot-grid { display:grid; grid-template-columns:2fr 1fr 1fr 1.3fr; gap:44px; margin-bottom:50px; }
        .sw-page .foot-logo { font-family:'Cormorant Garamond',serif; font-size:28px; color:#F7FAFC; font-weight:600; letter-spacing:1px; margin-bottom:18px; }
        .sw-page .foot-logo span { color:#4EC7B8; }
        .sw-page .foot-grid > div > p { font-size:14px; max-width:320px; line-height:1.7; }
        .sw-page .foot-col h5 { color:#F7FAFC; font-size:13px; text-transform:uppercase; letter-spacing:2px; margin-bottom:20px; font-weight:600; font-family:'Inter',sans-serif; }
        ...
        .sw-page .foot-col a:hover { color:#4EC7B8; }
