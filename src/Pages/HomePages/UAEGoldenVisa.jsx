...
/* ============================================================
   UAE GOLDEN VISA — Langma International
   Content sourced from the UAE Golden Visa page; visual design
   system (teal / ivory single-accent luxury-finance palette,
   layout, components and interactions) ported verbatim from the
   Panama Golden Visa React component.
============================================================ */
...
const NAV_LINKS = [
  { href: "#about", label: "The UAE" },
  { href: "#programme", label: "Golden Visa" },
...
const BENEFITS = [
  {
    ...
    title: "Residency without a sponsor",
    body: "No employer or local sponsor is required — a structural advantage over most other UAE residence categories.",
  },
  {
    icon: (
      <>
    ...
    body: "Personal income, capital gains, inheritance and gifts sit outside UAE taxation; corporate profit is taxed at just 9% above AED 375,000.",
  },
  {
    icon: (
      <>
    ...
    body: "Sponsor a spouse, unmarried sons under 25 and unmarried daughters of any age within the same application framework.",
  },
  {
    icon: (
      <>
    ...
    title: "Banking & lifestyle access",
    body: "Open multi-currency UAE bank accounts, exchange many foreign driving licences, and access the Esaad discount programme.",
  },
  {
    icon: <path d="M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7z" />,
    title: "Healthcare & education",
    body: "Access to a world-class medical hub and to international schools and English-taught universities for your children.",
  },
  {
    icon: <path d="M4 21V8l8-5 8 5v13M9 21v-6h6v6" />,
    title: "Route to citizenship",
    body: "A path toward naturalisation after 30 years of residence, or by exceptional merit — with a passport recognised in 176 countries.",
  },
];
...
const WHY_UAE = [
  {
    ...
    title: "For investors, by design",
    body: "Where most UAE visas depend on an employer or local sponsor, the Golden Visa is issued directly against a qualifying investment — most commonly, freehold real estate.",
  },
  {
    icon: (
      <>
    ...
    title: "Built on the 2022 reforms",
    body: "The 2022 update lowered the qualifying thresholds, removed minimum-stay obligations, and opened the route to off-plan property and mortgage-financed purchases.",
  },
  {
    icon: (
      <>
    ...
    title: "For entrepreneurs & professionals",
    body: "Beyond investors, the wider Golden Visa framework also recognises entrepreneurs, scientists, qualified professionals and individuals of exceptional talent.",
  },
  {
    icon: (
      <>
    ...
    title: "A base for global mobility",
    body: "Holders can treat the UAE as a genuine second home or operating base, without relinquishing their existing residence or citizenship elsewhere.",
  },
  {
    icon: <path d="M3 21V10l9-7 9 7v11M9 21v-7h6v7" />,
    title: "Anchored to a growth economy",
    body: "The visa ties your residency to a jurisdiction actively investing in finance, logistics, technology and innovation as pillars of its post-oil economy.",
  },
  {
    icon: (
      <>
        ...
        <path d="M3 19c0-2.8 2-4.4 5-4.4s5 1.6 5 4.4M13 19c0-2.4 1.8-3.8 4.3-3.8" />
      </>
    ),
    title: "A long-term family plan",
    body: "With family sponsorship built into the same framework, the Golden Visa is as much a multi-generational plan as it is a personal residency decision.",
  },
];

const FACTS = [
  { k: "Capital", v: "Abu Dhabi", s: "Political & cultural capital" },
  { k: "Population", v: "≈ 9.9 Million", s: "Highly international & expat-driven" },
  { k: "Currency", v: "Dirham · AED", s: "Stable, USD-pegged" },
  { k: "Federation", v: "7 Emirates", s: "United since 1971" },
  { k: "Business Hub", v: "Dubai", s: "Global finance & logistics centre" },
  { k: "Landmark", v: "Burj Khalifa", s: "The world's tallest building" },
  { k: "Personal Tax", v: "0%", s: "No personal income tax" },
  { k: "Passport Access", v: "176 Countries", s: "Visa-free or visa-on-arrival" },
];
...
const TIMELINE = [
  { n: 1, title: "Preliminary due diligence", body: "A confidential pre-check of your background, income source and documents — typically completed within a day — to flag potential issues before formal filing and strengthen your application." },
  { n: 2, title: "Documentation & entry visa", body: "Assembling, translating, notarising and legalising your file over roughly five to seven weeks, while securing the 6-month entry visa that lets you view properties and progress your case in the UAE." },
  { n: 3, title: "Real estate selection & purchase", body: "Choosing and completing a freehold property purchase suited to your goals, typically over five to six weeks in parallel with documentation, with full purchase-agreement and title-registration support." },
  { n: 4, title: "Medical fitness check", body: "A short clinic examination — usually one to five days — screening applicants and family members over 18 for specified infectious diseases, required before the visa can be issued." },
  { n: 5, title: "Biometrics & due diligence", body: "Submitting biometrics to the General Directorate of Residency and Foreigners Affairs; review typically takes five to seven days, extending to as much as 30 if further information is requested." },
  { n: 6, title: "Visa issuance & long-term planning", body: "Once approved, visas are issued for you and your family, followed by guidance on maintaining status, renewals, and your long-term position in the UAE." },
];
...
const DOCS = [
  {
    ...
    body: "A registration fee of AED 160,000+ (about $21,800+), payable on completion of the qualifying purchase.",
  },
  {
    icon: (
      <>
    ...
    title: "Visa & Emirates ID fees",
    body: "State fees of approximately AED 3,860 (about $1,043) per person for visa issuance and identity cards.",
  },
  {
    icon: (
      <>
    ...
    body: "A medical fitness check from around $220 per person, plus health insurance from approximately $400 per person.",
  },
  {
    icon: <path d="M3 12l9-9 9 9M6 10v10h12V10" />,
    title: "Freehold zone property",
    body: "Investment property must sit within one of the UAE's designated freehold zones, where foreign nationals may hold full title.",
  },
  {
    icon: <path d="M12 2v20M6 6h9a3 3 0 010 6H6M6 12h11" />,
    title: "Legal source of funds",
    body: "Applicants must be able to demonstrate the legal origin of the invested capital as part of the due-diligence review.",
  },
  {
    icon: (
      <>
    ...
    body: "Translation, notarisation and consular legalisation of supporting documents from approximately $1,000 per person.",
  },
];
...
const FAMILY = [
  {
    ...
    title: "Main investor",
    body: "Aged 18 or over, able to confirm the legal source of their investment income, with a clean criminal record and free of specified infectious diseases.",
  },
  {
    icon: <path d="M12 21C7 17 4 13 4 9a8 8 0 0116 0c0 4-3 8-8 12z" />,
    title: "Spouse",
    body: "Aged 18 or over, with a clean criminal record and free of specified infectious diseases, included on the same application.",
  },
  {
    icon: (
      <>
        <circle cx="12" cy="8" r="2.8" />
        <path d="M6 20c0-3.2 2.6-5 6-5s6 1.8 6 5" />
      </>
    ),
    title: "Sons",
    body: "Unmarried sons under the age of 25, subject to the same health requirements once they turn 18.",
  },
  {
    icon: (
      <>
    ...
    title: "Daughters",
    body: "Unmarried daughters of any age may be included, provided they remain unmarried and meet the standard health requirements.",
  },
];

const LANGMA_CAPABILITIES = [
  { title: "Global mobility expertise", body: "Cross-border residency experience across the Gulf and beyond, applied to your specific circumstances." },
  { title: "Personalised consultation", body: "A considered assessment of your investment, family and goals — not a templated checklist." },
  ...
  { title: "Application guidance", body: "Coordination through every official stage, with licensed UAE legal professionals where required." },
  { title: "International network", body: "Trusted partners on the ground — legal, tax, banking and real estate — to keep your relocation moving." },
...
const FAQS = [
  {
    ...
    a: "A long-term residence visa introduced in 2019 for investors, entrepreneurs, scientists, qualified professionals and exceptional talents. It lets the holder and eligible family members live in the UAE on a renewable, multi-year basis without needing an employer or local sponsor.",
  },
  {
    q: "How much do I need to invest?",
    a: "Buying freehold property worth AED 2,000,000 or more (about $545,000) qualifies you for a 10-year visa. Property worth AED 750,000 or more (about $204,000) qualifies you for a 2-year visa; if titled jointly with a spouse, the threshold rises to AED 1,000,000 (about $272,255).",
  },
  {
    q: "Can I use a mortgage to buy the qualifying property?",
    a: "Yes. The 10-year route generally requires a minimum 20% down payment, while the 2-year route typically requires a minimum 50% down payment through a UAE bank.",
  },
  {
    q: "Do I have to live in the UAE full-time?",
    a: "No. Residing in the UAE is not compulsory to keep your Golden Visa — holders typically only need to visit once or twice a year to maintain their status.",
  },
  {
    q: "Can I bring my family?",
    a: "Yes. You can sponsor a spouse, unmarried sons under 25 and unmarried daughters of any age within the same application. A separate parent-sponsorship route exists for UAE residents, subject to its own conditions.",
  },
  {
    q: "What taxes will I pay?",
    a: "The UAE does not tax personal income, and capital gains, inheritances, gifts and personal property are exempt for individuals. Corporate profit is untaxed up to AED 375,000 and taxed at a flat 9% above that.",
  },
  {
    q: "How long does the process take?",
    a: "Typically upwards of two months in total, covering due diligence, documentation, a six-month entry visa, property purchase, a medical check and biometric enrolment.",
  },
  {
    q: "What are the eligibility requirements?",
    a: "The main applicant must be at least 18, able to show the legal source of their investment funds, hold a clean criminal record, and be free of specified infectious diseases such as HIV or tuberculosis.",
  },
  {
    q: "Does it lead to citizenship?",
    a: "In time, yes. Naturalisation is possible after 30 years of legal residence, or in select cases by exceptional merit. A UAE passport currently allows visa-free or visa-on-arrival access to 176 countries, including the Schengen Area, the UK and Canada.",
  },
  {
    q: "Can I buy off-plan property to qualify?",
    a: "Yes. Since the 2022 reform, investors may purchase off-plan units from approved developers in the UAE's freehold zones, alongside completed properties, provided the investment meets the qualifying threshold.",
  },
  {
    q: "What is the Esaad Privilege Card?",
    a: "A Dubai discount programme available to Golden Visa holders, offering reductions of up to 70% at participating shops, clinics and service providers in the UAE and, in some cases, abroad.",
  },
  {
    q: "Can I open a UAE bank account?",
    a: "Yes. Golden Visa holders can open personal accounts with UAE banks in dirhams, US dollars, euros and other major currencies, supporting international transfers and everyday banking.",
  },
  {
    q: "What is the difference between the two real estate routes?",
    a: "Both are obtained through freehold property purchase. The 10-year route requires AED 2,000,000+ and offers the longest validity. The 2-year route requires AED 750,000+ (AED 1,000,000+ for jointly titled spousal ownership) and is renewable while the qualifying investment is maintained.",
  },
  {
    q: "Will I need to pass a UAE driving test?",
    a: "It depends on nationality. Most residents must pass a UAE exam, but citizens of several countries — including the United States, the United Kingdom, Germany, Australia, Turkey, Spain and India — may exchange their existing licence without retesting.",
  },
  {
    q: "What healthcare and education access is included?",
    a: "Access to the UAE's private and public healthcare network — a recognised hub for specialties such as dentistry, orthopaedics and dermatology — and to international schools and English-taught universities for your children.",
  },
  {
    q: "Is a local sponsor or employer required?",
    a: "No. Unlike several other UAE residence categories, the Golden Visa does not require an employer or a local sponsor, which is part of what makes the investment route comparatively direct.",
  },
];
...
export default function UaeGoldenVisa() {
  ...
  const { handleSubmit: submitConsultation, loading, submitted, doneText, errorMsg } =
    useGoldenVisaConsultationForm("UAE Golden Visa", { leadType: "Golden Visa Consultation" });
...
.ugv *,.ugv *::before,.ugv *::after{box-sizing:border-box;}
.ugv{scroll-behavior:smooth;-webkit-text-size-adjust:100%;}
.ugv{
  margin:0;
...
.ugv img{max-width:100%;display:block;}
.ugv a{color:inherit;text-decoration:none;}
.ugv h1,.ugv h2,.ugv h3,.ugv h4{font-family:var(--serif);font-weight:600;line-height:1.08;letter-spacing:.2px;color:var(--navy);margin:0;}
.ugv p{margin:0 0 1.1em;}
.ugv ::selection{background:var(--gold);color:#fff;}
...
.stat{flex:1 1 120px;padding:6px 20px;border-left:1px solid var(--sand-line);}
.stat:first-child{border-left:0;padding-left:0;}
.stat__num{font-family:var(--serif);font-size:clamp(1.5rem,2.4vw,2.2rem);font-weight:600;color:var(--navy);line-height:1;white-space:nowrap;}
...
/* ============================================================
   LIFE IN THE UAE — DUOTONE MOSAIC
============================================================ */
...
@media (prefers-reduced-motion:reduce){
  .ugv *{animation:none !important;transition-duration:.01ms !important;scroll-behavior:auto !important;}
  .reveal{opacity:1;transform:none;}
      ...
      <div className="ugv">
        ...
        <main id="main-content">
            ...
            <div className="wrap">
              <div className="hero__grid">
                <div className="hero__copy">
                  <span className="eyebrow hero__eyebrow">UAE · Long-Term Residency by Investment</span>
                  <h1>The UAE <em>Golden&nbsp;Visa</em>, your gateway to long-term Gulf residency.</h1>
                  <p className="hero__sub">Anchor your life, your capital and your family in one of the world's most dynamic economies. The UAE Golden Visa offers a direct route to long-term residency, a personal tax-free environment and a global business address — without a local sponsor or employer.</p>
                  ...
                  <div className="hero__stats">
                    <div className="stat">
                      <div className="stat__num">AED 750K<span style={{ color: "var(--muted-2)", fontSize: ".5em" }}>*</span></div>
                      <div className="stat__label">Investment From</div>
                    </div>
                    <div className="stat">
                      <div className="stat__num">2 or 10</div>
                      <div className="stat__label">Year Residency Validity</div>
                    </div>
                    <div className="stat">
                      <div className="stat__num">0%</div>
                      <div className="stat__label">Personal Income Tax</div>
                    </div>
                  </div>
                  <p style={{ fontSize: "11.5px", color: "var(--muted-2)", margin: "12px 0 0" }}>
                    *Minimum reference figure; the 10-year route requires freehold property of AED 2,000,000+.
                  </p>
                </div>
                ...
                <div className="hero__media">
                  <div className="hero__media-frame">
                    <img
                      ...
                      loading="eager"
                    />
                    <span className="hero__media-tag">Dubai · United Arab Emirates</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="wrap">
              <div className="split">
                <Reveal>
                  ...
                  <h2 className="display">The UAE Golden Visa,<br />explained clearly</h2>
                  <p className="lede">Launched in 2019 and substantially reformed in 2022, the <strong>Golden Visa</strong> was built to let the UAE compete directly for global capital and talent — by removing the sponsorship barrier that governs most other residence categories.</p>
                  <p style={{ color: "var(--muted)" }}>Rather than depending on an employer or a local sponsor, the visa is issued directly against a qualifying investment — most commonly, freehold real estate. It suits internationally mobile families who value a genuine second home and operating base without relinquishing their existing residence or citizenship. Langma International guides you through every stage, introducing licensed UAE legal professionals where local representation is required.</p>
                  <a href="#investment" className="btn btn--dark btn-animated">See the Investment Routes</a>
                </Reveal>
                <Reveal className="split__panel">
                  <div className="factline"><span className="factline__n">01</span><div><div className="factline__t">What is the Golden Visa?</div><div className="factline__d">A long-term UAE residence visa, introduced in 2019, for investors, entrepreneurs, scientists, qualified professionals and exceptional talents — reformed in 2022.</div></div></div>
                  <div className="factline"><span className="factline__n">02</span><div><div className="factline__t">Who can apply?</div><div className="factline__d">The main applicant must be 18 or older, able to demonstrate the legal source of their investment funds, hold a clean criminal record, and be free of specified infectious diseases.</div></div></div>
                  <div className="factline"><span className="factline__n">03</span><div><div className="factline__t">The investment test</div><div className="factline__d">Freehold property of AED 2,000,000+ for a 10-year visa, or AED 750,000+ for a 2-year visa (AED 1,000,000+ if jointly titled with a spouse) — off-plan or completed.</div></div></div>
                  <div className="factline"><span className="factline__n">04</span><div><div className="factline__t">Mortgage-backed purchase</div><div className="factline__d">A UAE mortgage is available on both routes: a minimum 20% down payment for the AED 2,000,000+ route, and 50% for the AED 750,000+ route.</div></div></div>
                  <div className="factline"><span className="factline__n">05</span><div><div className="factline__t">The 6-month bridge</div><div className="factline__d">Applicants receive a 6-month entry visa to view and purchase property, complete their medical check and lodge the formal application.</div></div></div>
                  <div className="factline"><span className="factline__n">06</span><div><div className="factline__t">Long-term flexibility</div><div className="factline__d">No obligation to reside full-time — visiting once or twice a year maintains status — with naturalisation possible after 30 years, or by exceptional merit.</div></div></div>
                </Reveal>
              </div>
            </div>
          </section>
          ...
          <section className="section section--sand" id="investment">
            <div className="wrap">
              <Reveal className="head head--center">
                ...
                <h2 className="display">What you need<br />to invest</h2>
                <p className="lede" style={{ margin: "18px auto 0" }}>The Golden Visa rests on a qualifying freehold real estate purchase rather than a business plan or employment offer. Each route grants long-term residency for you and your qualifying family.</p>
              </Reveal>

              <div className="grid grid-3" style={{ marginTop: "56px" }}>
                <Reveal as="article" className="route route--featured hover-card">
                  <span className="route__tag">Longest Validity</span>
                  <div className="route__label">10-Year Golden Visa</div>
                  <div className="route__amt">AED 2,000,000+<small>Freehold real estate · off-plan or completed · min. 20% down payment</small></div>
                  <ul className="route__list">
                    <li><Check />Residential or commercial freehold property</li>
                    <li><Check />Off-plan permitted from approved developers</li>
                    <li><Check />Mortgage financing available on this route</li>
                    <li><Check />The longest residency validity period</li>
                  </ul>
                  <a href="#book" className="btn btn--wide btn-animated">Discuss This Route</a>
                </Reveal>

                <Reveal as="article" className="route hover-card">
                  <div className="route__label">2-Year — Individual Title</div>
                  <div className="route__amt">AED 750,000+<small>Freehold real estate · min. 50% down payment</small></div>
                  <ul className="route__list">
                    <li><Check />Held in a single applicant's name</li>
                    <li><Check />Renewable while the investment is maintained</li>
                    <li><Check />Off-plan or completed freehold property</li>
                    <li><Check />A lower entry point to the programme</li>
                  </ul>
                  <a href="#book" className="btn btn--wide btn--dark btn-animated">Discuss This Route</a>
                </Reveal>

                <Reveal as="article" className="route hover-card">
                  <div className="route__label">2-Year — Jointly Titled</div>
                  <div className="route__amt">AED 1,000,000+<small>Freehold real estate titled jointly with a spouse</small></div>
                  <ul className="route__list">
                    <li><Check />Title registered jointly with a spouse</li>
                    <li><Check />Renewable while the investment is maintained</li>
                    <li><Check />Off-plan or completed freehold property</li>
                    <li><Check />Suited to couples buying together</li>
                  </ul>
                  <a href="#book" className="btn btn--wide btn--dark btn-animated">Discuss This Route</a>
                </Reveal>
              </div>
              ...
              <Reveal className="disclaimer">
                <strong>Please note.</strong> Mortgage financing is available on both routes — a minimum 20% down payment for the AED 2,000,000+ route, and 50% for the AED 750,000+ route. Beyond the qualifying purchase, budget for a property registration fee of AED 160,000+ (about $21,800+), visa and Emirates ID state fees of approximately AED 3,860 (about $1,043) per person, a medical fitness check from around $220 per person, health insurance from approximately $400 per person, and document translation, notarisation and legalisation from approximately $1,000 per person. Investment thresholds, government fees and eligibility conditions are set by the UAE authorities and can change. The figures shown are indicative and current to the best of our research; the precise terms applicable to your case are confirmed in writing during your consultation and by licensed UAE professionals. This page is informational and is not legal, tax or immigration advice.
              </Reveal>
            </div>
          </section>
          ...
          {/* ============================ WHY UAE ============================ */}
          <section className="section section--navy" id="why-uae">
            <div className="wrap">
              <Reveal className="head">
                <span className="eyebrow">About the UAE Golden Visa</span>
                <h2 className="display">Designed around the<br />investor, not the employer</h2>
                <p className="lede" style={{ marginTop: "18px" }}>The 2022 reforms lowered qualifying thresholds, removed minimum-stay obligations, and opened the route to off-plan property and mortgage-financed purchases — recasting UAE residency as a plan for globally mobile families.</p>
              </Reveal>
              <div className="grid grid-3" style={{ marginTop: "52px" }}>
                {WHY_UAE.map((c) => (
          ...
          <section className="section" id="about">
            <div className="wrap">
              <div className="split" style={{ marginBottom: "56px" }}>
                <Reveal>
                  <span className="eyebrow">The United Arab Emirates</span>
                  <h2 className="display">A federation built<br />for ambition</h2>
                </Reveal>
                <Reveal>
                  <p style={{ color: "var(--muted)" }}>The UAE is a federation of seven emirates on the Arabian Peninsula, anchored by the global business capital of Dubai and the political and cultural capital, Abu Dhabi. In little more than two generations, it has grown from a modest coastal economy into one of the world's most connected financial and logistics hubs, at the crossroads of Europe, Asia and Africa.</p>
                  <p style={{ color: "var(--muted)", marginBottom: 0 }}>Its skyline — headlined by the Burj Khalifa, the world's tallest building — is shorthand for a wider story: a state that has engineered a business environment, an infrastructure network and a personal tax regime designed to draw capital, talent and ambition from every continent. For investors and their families, that means physical safety, deep connectivity, a sophisticated lifestyle, and a residency framework that rewards commitment without demanding permanent relocation.</p>
                </Reveal>
              </div>
          ...
          {/* ============================ LIFE IN THE UAE — MOSAIC ============================ */}
          <section className="section section--sand" id="life">
            <div className="wrap">
              <Reveal className="head head--center">
                <span className="eyebrow eyebrow--center">Life in the UAE</span>
                <h2 className="display">Where will you build<br />your Emirates life?</h2>
                <p className="lede" style={{ margin: "16px auto 0" }}>From the global business energy of Dubai to the refined, institutional calm of Abu Dhabi, the UAE offers genuinely distinct settings for distinct ambitions.</p>
              </Reveal>
          ...
          <section className="section section--navy" id="process">
            <div className="wrap">
              <Reveal className="head head--center">
                ...
                <p className="lede" style={{ margin: "16px auto 0" }}>Langma International coordinates every stage and introduces licensed UAE legal professionals where local representation is required.</p>
              </Reveal>
          ...
          <section className="section" id="documents">
            <div className="wrap">
              <Reveal className="head">
                ...
                <h2 className="display">The fees and conditions,<br />set out plainly</h2>
                <p className="lede" style={{ marginTop: "16px" }}>Beyond the qualifying purchase, a handful of state fees and conditions apply. We prepare and sequence each item before anything is submitted.</p>
              </Reveal>
          ...
          <section className="section section--sand" id="family">
            <div className="wrap">
              <Reveal className="head head--center">
                ...
                <p className="lede" style={{ margin: "16px auto 0" }}>The main applicant may extend UAE residency to the people closest to them, within the same framework.</p>
              </Reveal>
          ...
          <section className="section" id="tax">
            <div className="wrap">
              <div className="split">
                <Reveal>
                  <span className="eyebrow">Tax Environment</span>
                  <h2 className="display">One of the world's<br />most efficient regimes</h2>
                  <p className="lede" style={{ marginTop: "16px" }}>The UAE levies no personal income tax, and individual capital gains, inheritances, gifts and property holdings all sit outside the scope of personal taxation — a structure shared by very few major economies.</p>
                  <p style={{ color: "var(--muted)" }}>Corporate taxation is similarly restrained: profits below AED 375,000 remain untaxed, with a flat 9% rate applying above that threshold — still low by comparison with most OECD jurisdictions. Because outcomes ultimately depend on your personal circumstances and your home country's own rules, we always introduce clients to qualified tax advisers before any decision is finalised.</p>
                </Reveal>
                <Reveal className="split__panel">
                  <div className="factline"><span className="factline__n">✓</span><div><div className="factline__t">Personal income tax</div><div className="factline__d">Nil. The UAE does not levy personal income tax on individuals.</div></div></div>
                  <div className="factline"><span className="factline__n">✓</span><div><div className="factline__t">Corporate tax up to AED 375,000</div><div className="factline__d">Profit below the threshold is untaxed.</div></div></div>
                  <div className="factline"><span className="factline__n">!</span><div><div className="factline__t">Corporate tax above AED 375,000</div><div className="factline__d">A flat 9% rate applies above the threshold — low by OECD standards.</div></div></div>
                  <div className="factline"><span className="factline__n">✓</span><div><div className="factline__t">Inheritance, gift &amp; estate tax</div><div className="factline__d">None for individuals under the domestic regime.</div></div></div>
                </Reveal>
              </div>
              <Reveal className="disclaimer">
                <strong>Not tax advice.</strong> The above is a general summary of publicly available information and does not constitute tax, legal or financial advice. Personal tax outcomes also depend on your country of citizenship and tax residence elsewhere, and can change. Langma International is not a tax adviser; please obtain personalised advice from a licensed professional before making any decision.
              </Reveal>
            </div>
          </section>
            ...
            <div className="wrap">
              <div className="split" style={{ alignItems: "center" }}>
                <Reveal>
                  ...
                  <p className="lede" style={{ marginTop: "18px" }}>We help investors, entrepreneurs and families access UAE residency through transparent guidance, strategic planning and genuinely personalised support — never overpromising, never guaranteeing outcomes we cannot control.</p>
                  <p style={{ color: "var(--muted)" }}>From your first conversation to your Emirates ID, you work with people who understand both the regulation and the human reality of building a life and a portfolio abroad, in coordination with licensed UAE legal professionals who file with the authorities.</p>
                </Reveal>
                <Reveal>
                  ...
                  <p style={{ color: "var(--muted-2)", fontSize: "13px", marginTop: "22px", lineHeight: "1.6" }}>
                    Figures reflect Langma International's wider institutional experience across language, training and global-mobility services. Legal immigration processing in the UAE is carried out by licensed UAE counsel with whom we coordinate.
                  </p>
                </Reveal>
              </div>
          ...
          <section className="section" id="book">
            <div className="wrap">
                  ...
                  {!submitted ? (
                    <div>
                      ...
                      <form ref={formRef} noValidate onSubmit={(e) => submitConsultation(e, { selectedDate, selectedTime })}>
                        ...
                        <div className="field">
                          <label htmlFor="fInterest">Your primary interest</label>
                          <select id="fInterest" name="interest" defaultValue="">
                            <option value="">Please select</option>
                            <option>Real estate investment</option>
                            <option>Business relocation</option>
                            <option>Family residency planning</option>
                            <option>Tax &amp; financial planning</option>
              ...
              {/* OFFICE VISIT */}
              <Reveal className="office">
                <div className="office__c">
                  <div className="k">Visit our office</div>
                  <div className="v">Langma International<br />E-73, South Extension Part-I<br />New Delhi – 110049, India</div>
                </div>
                <div className="office__c">
                  <div className="k">Speak with us</div>
                  <div className="v"><a href="tel:+919810117094">+91 98101 17094</a><br /><a href="mailto:info@langmainternational.com">info@langmainternational.com</a></div>
                </div>
                <div className="office__c">
                  <div className="k">Consultation hours</div>
                  <div className="v">Monday – Saturday<br />By appointment<br />Confidential, no-obligation</div>
                </div>
              </Reveal>
            </div>
          </section>
