...
export default function LangmaJapaneseCourse() {
  ...
  * { min-width: 0; }
  ...
  `}</style>
      ...
      {/* COURSE DETAILS / QUICK FACTS */}
      <section className="course-details" id="course-details"><div className="wrap"><div className="sec-head-row"><div className="sec-head reveal"><h2>Your <span className="heading-accent">Japan </span> Dream Starts with Langma.
