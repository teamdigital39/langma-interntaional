...
import "./learnJapaneseLanding.css";
...
const FAQ_ITEMS = [
  {
    title: "What are the benefits of learning Japanese with Langma School of Languages?",
    lines: [
      "Langma offers structured courses designed by language experts.",
      "Interactive lessons enhance speaking, listening, reading, and writing skills.",
      "Cultural insights provide a deeper understanding of Japanese society.",
    ],
  },
  {
    title: "How can I enroll in Japanese language courses with Langma School of Languages?",
    lines: [
      "Visit our website and browse available Japanese language programs.",
      "Select a course based on your proficiency level and learning goals.",
      "Complete the enrollment process online or contact our support for assistance.",
    ],
  },
  {
    title: "What makes Langma's Japanese courses effective for beginners?",
    lines: [
      "Our courses start with fundamental Japanese grammar and vocabulary.",
      "Practical exercises and dialogues help beginners build confidence in speaking.",
      "Experienced instructors provide personalized feedback and guidance.",
    ],
  },
  {
    title: "Can I learn Japanese online with Langma School of Languages?",
    lines: [
      "Yes, Langma offers comprehensive online Japanese courses.",
      "Study from anywhere with live sessions and access to learning materials.",
...
function useLandingBodyClass() {
  useLayoutEffect(() => {
    document.body.classList.add("japanese-landing-active");
    return () => document.body.classList.remove("japanese-landing-active");
  }, []);
}
...
export default function LearnJapaneseLanguage() {
  useLandingBodyClass();
  useStickyHeader();
  useBackToTop();
  ...
  useEffect(() => {
    document.title =
      "Japanese Language Course, Japanese Speaking Course Online, Japanese Classes in Delhi";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute(
        "content",
        "Learn online Japanese language course with certificate, Japanese speaking course, Japanese language training, Japanese speaking course, Japanese classes in Delhi with Langma."
      );
    }
  }, []);
  ...
  return (
    ...
    <div
      className="learn-japanese-landing"
      style={{ "--japanese-hero-bg": `url(${img("hero.webp")})` }}
    >
              ...
              <div className="hero-section-text">
                <h1>
                  ...
                  <img
                    alt="img"
                    className="dotsc"
                    src={img("japanese.webp")}
                    width="50"
                    height="40"
                  />{" "}
                  Language From <span className="branding">N5</span>
                  To <span className="branding">N1</span> With{" "}
                  <span className="branding">Langma</span>
                </h1>
                <p>
                  Our trainers will help you to <b>understand</b> the benefits of
                  various <b>Japanese language levels</b>. Langma School of Languages
            ...
            <div className="col-xl-6">
              ...
              >
                <div className="mb-lg-5 mb-3 d-flex align-items-center">
                  ...
                  <div>
                    <p className="p-0">
                      Start your journey with mastering <b>Japanese Language!</b> from N5
                      to N1
                    </p>
                    <h2>Enroll Today</h2>
                  </div>
                ...
                <input type="hidden" name="currenturl" value={`${window.location.origin}/learn-japanese-language`} />
                <input type="hidden" name="language" value="Japanese" />
                <input type="hidden" name="message" value="Japanese" />
                <button type="submit" className="batton" disabled={submitting}>
                  {submitting ? "Submitting..." : "Submit"}
                </button>
                {formMessage && (
                  <p className="japanese-landing-form-msg">{formMessage}</p>
                )}
              </form>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              ...
              <div className="we-are">
                <p>
                  Learn <span>Japanese Language From N5 To N1</span> With Langma School
            ...
            <div className="col-lg-5">
              <div className="we-are-img">
                <img alt="we-are" src={img("we-are-japanese.webp")} width="513" height="519" />
              </div>
            </div>
          </div>
          ...
          <div className="row" style={{ marginTop: "40px" }}>
            <div className="col-lg-4">
              <div className="service">
                ...
                <p>
                  Our institute specializes in teaching japanese to young learners,
            ...
            <div className="col-lg-4">
              <div className="service">
                ...
                <p>
                  College students can enhance their japanese language skills by enrolling
            ...
            <div className="col-lg-4">
              <div className="service">
                ...
                <p>
                  Master Business Japanese, Conquer Communication, Open doors to
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="some-features-img">
                <img alt="img" src={img("some-features-japanese.webp")} loading="lazy" width="565" height="565" />
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
              <div className="creative-design">
                ...
                <h5>N5 Beginner</h5>
                <p>
                  The N5 exam assesses your ability to understand and utilize basic Japanese in everyday situations. Think greetings, simple conversations, shopping in a convenience store, or reading restaurant menus.
                </p>
              </div>
              <div className="creative-design shaps-2 mb-xl-0">
                ...
                <p>
                  The N4 exam assesses your ability to navigate intermediate Japanese in everyday situations. Think deeper conversations, understanding news on familiar topics, and reading short articles or manga.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 ps-xl-4">
              <div className="creative-design shaps-3">
                ...
                <h5>N2 Advanced</h5>
                <p>
                  N2 assesses your ability to handle upper-intermediate Japanese in academic and professional settings. Think engaging in sophisticated discussions, understanding technical information, and reading complex academic texts and literature.
                </p>
              </div>
              <div className="creative-design shaps-4 mb-0">
                ...
                <h5>N1 Native</h5>
                <p>
                  N1 assesses your ability to handle native-level Japanese in academic, professional, and social settings. Think engaging in complex discussions on any topic, understanding sophisticated texts, and expressing yourself with precision and nuance in both spoken and written forms.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="team-expert">
                <img alt="img" src={img("003.webp")} loading="lazy" width="195" height="195" />
                <div>
                  <span>Publisher</span>
                  <h4>Arya - Magzine Mania</h4>
                  <p>
                    I am immensely grateful for my journey of learning Japanese at Langma School of Languages. The comprehensive course structure, engaging lessons, and dedicated instructors made the entire experience enriching and enjoyable.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="team-expert mb-0">
                <img alt="img" src={img("004.webp")} loading="lazy" width="195" height="195" />
                <div>
                  <span>Editor</span>
                  <h4>Suranga- Signzma</h4>
                  <p>
                    Learning Japanese at Langma School of Languages has been an incredible asset to my professional life. The practical curriculum and expert instructors provided me with the skills to confidently use Japanese in my workplace. Thanks to Langma.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="questions-img">
                <img alt="questions" src={img("questions-japanese.webp")} loading="lazy" width="507" height="668" />
                <img alt="img" className="dots" src={img("dots.png")} width="94" height="85" />
              </div>
            </div>
            <div className="col-lg-6">
