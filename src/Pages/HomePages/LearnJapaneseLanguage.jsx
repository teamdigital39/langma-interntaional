...
export default function LangmaJapaneseCourse() {
  ...
  async function handleRequestSubmit(e) {
    ...
    setRequestFormMessage("");
    const typeMessages = {
      demo: "Interested in Learning Japanese - Request Demo",
      study: "Interested in Study in Japan Program",
      work: "Interested in Work in Japan Pathway",
      ssw: "Interested in SSW (Skilled Worker) Program",
  ...
  * { min-width: 0; }
  ...
  .activity-image{width:100%; aspect-ratio:5/0; height:auto; object-fit:contain; object-position:center; display:block; flex-shrink:0; background:#142536; transition:transform .5s var(--ease); will-change:transform; contain:layout style paint;}
  ...
  `}</style>
      ...
      {showAnnouncement && (
        <div className="announcement-bar" ref={announceRef}>
          <div className="announcement-inner">
            <span className="announcement-text">🎌 New Japanese batch enrolling now — few seats available!</span>
              ...
              <form className="ticket-form" onSubmit={handleHeroSubmit}>
                <div className="ticket-form-row">
                  ...
                  <div className="form-row">
                    ...
                    <input type="email" id="hemail" name="email" autoComplete="email" placeholder="Your email" required />
                  </div>
                </div>
        ...
        <div className="wrap">
          ...
          <div className="audience-grid reveal-group">
            ...
            <div className="audience-card">
              ...
              <button className="btn btn-primary btn-sm" onClick={() => openRequestPopup('ssw')} style={{marginTop: '14px', width: '100%', justifyContent: 'center', cursor: 'pointer'}}>Request SSW Program Info</button>
            </div>
            <div className="audience-card">
          ...
          <div className="section-cta-big">
            ...
            <p className="section-cta-subtext">Study in Japan, work in Japan, or build practical skills for everyday life.</p>
            <a className="btn btn-primary btn-large" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20help%20choosing%20the%20right%20Japanese%20learning%20path." target="_blank" rel="noopener">
      ...
      <section id="skills">
        <div className="wrap">
          ...
          <div className="section-cta-big">
            ...
            <p className="section-cta-subtext">Speaking, listening, reading & writing—master Japanese comprehensively with expert guidance.</p>
            <a className="btn btn-wa btn-large" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I%27d%20like%20to%20book%20a%20free%20Japanese%20demo%20class." target="_blank" rel="noopener">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 2c-5.5 0-9.96 4.46-9.96 9.96 0 1.76.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.5 0 9.96-4.46 9.96-9.96S17.54 2 12.04 2zm5.86 14.13c-.25.7-1.45 1.34-2 1.42-.51.08-1.15.11-1.86-.12-.43-.14-.98-.32-1.69-.63-2.97-1.28-4.9-4.27-5.05-4.47-.15-.2-1.22-1.62-1.22-3.09 0-1.47.77-2.19 1.05-2.49.27-.3.6-.37.8-.37.2 0 .4 0 .58.01.19.01.44-.07.68.53.25.6.85 2.08.92 2.23.07.15.12.32.02.52-.1.2-.15.32-.3.49-.15.17-.31.38-.44.51-.15.15-.3.31-.13.6.17.3.75 1.25 1.62 2.02 1.11.99 2.05 1.3 2.35 1.45.3.15.47.12.65-.07.18-.19.75-.87.95-1.17.2-.3.4-.25.66-.15.27.1 1.73.82 2.02.97.3.15.5.22.57.35.07.13.07.75-.18 1.45z"/></svg>
              Book Your Free Demo
            </a>
      ...
      <section className="testimonials" id="testimonials">
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p>Real stories from learners who have made their move to Japan. Watch how Langma transformed their Japanese journey.</p>
          </div>
      ...
      <section className="pathways" id="pathways">
        <div className="wrap">
          <div className="sec-head reveal">
            <h2>{['SSW pathways for manufacturing & caregiving', 'Tech & engineering roles in Japan', 'University & study abroad routes', 'Business visa pathways in Tokyo'][Math.floor(Math.random() * 4)]}</h2>
            <p>Langma's counsellors don't stop at fluency. We guide candidates through Japan work, study, and skilled worker pathways suited to their goals and qualifications.</p>
          </div>
      ...
      {/* FLOATING WHATSAPP */}
      <a href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I'd%20like%20to%20know%20more%20about%20the%20Japanese%20course." target="_blank" rel="noopener" className="wa-float" id="waFloat" aria-label="Chat on WhatsApp"><svg width="30" height="30" viewBox="0 0 24 24" fill="#fff"><path d="M12.04 2c-5.5 0-9.96 4.46-9.96 9.96 0 1.76.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.5 0 9.96-4.46 9.96-9.96S17.54 2 12.04 2zm5.86 14.13c-.25.7-1.45 1.34-2 1.42-.51.08-1.15.11-1.86-.12-.43-.14-.98-.32-1.69-.63-2.97-1.28-4.9-4.27-5.05-4.47-.15-.2-1.22-1.62-1.22-3.09 0-1.47.77-2.19 1.05-2.49.27-.3.6-.37.8-.37.2 0 .4 0 .58.01.19.01.44-.07.68.53.25.6.85 2.08.92 2.23.07.15.12.32.02.52-.1.2-.15.32-.3.49-.15.17-.31.38-.44.51-.15.15-.3.31-.13.6.17.3.75 1.25 1.62 2.02 1.11.99 2.05 1.3 2.35 1.45.3.15.47.12.65-.07.18-.19.75-.87.95-1.17.2-.3.4-.25.66-.15.27.1 1.73.82 2.02.97.3.15.5.22.57.35.07.13.07.75-.18 1.45z"/></svg></a>
      ...
      <div className="mobile-cta-bar" aria-label="Quick contact buttons">
        ...
        <div className="mobile-cta-bar-actions">
          <a className="mobile-cta-bar-wa" href="https://wa.me/919810117094?text=Hi%20Langma%2C%20I'd%20like%20to%20know%20more%20about%20the%20Japanese%20course." target="_blank" rel="noopener" aria-label="Chat with Langma on WhatsApp"><svg width="24" height="24" viewBox="0 0 24 24" fill="#fff"><path d="M12.04 2c-5.5 0-9.96 4.46-9.96 9.96 0 1.76.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.5 0 9.96-4.46 9.96-9.96S17.54 2 12.04 2zm5.86 14.13c-.25.7-1.45 1.34-2 1.42-.51.08-1.15.11-1.86-.12-.43-.14-.98-.32-1.69-.63-2.97-1.28-4.9-4.27-5.05-4.47-.15-.2-1.22-1.62-1.22-3.09 0-1.47.77-2.19 1.05-2.49.27-.3.6-.37.8-.37.2 0 .4 0 .58.01.19.01.44-.07.68.53.25.6.85 2.08.92 2.23.07.15.12.32.02.52-.1.2-.15.32-.3.49-.15.17-.31.38-.44.51-.15.15-.3.31-.13.6.17.3.75 1.25 1.62 2.02 1.11.99 2.05 1.3 2.35 1.45.3.15.47.12.65-.07.18-.19.75-.87.95-1.17.2-.3.4-.25.66-.15.27.1 1.73.82 2.02.97.3.15.5.22.57.35.07.13.07.75-.18 1.45z"/></svg></a>
