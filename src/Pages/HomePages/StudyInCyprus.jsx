    ...
    >
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
          <div className="grid lg:grid-cols-2 items-center gap-12">
            ...
            <div className="z-10">
              ...
              >
                Study In <span className="text-[#2FC7A1]">Cyprus</span>
                <br />
                Europe's Modern
                <br />
                Student Destination.
      ...
      <section style={{ background: C.cream, padding: "100px 48px", position: "relative" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SectionHead
            tag={<span style={{ color: "#296166" }}>Why Cyprus</span>}
            title={
      ...
      <section style={{ background: C.cream, padding: "100px 48px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SectionHead
            ...
            title={<span style={{ color: "#296166" }}>What Will It Actually Cost You?</span>}
            sub={
              <span style={{ color: "#296166" }}>
      ...
      <section style={{ background: C.white, padding: "100px 48px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SectionHead
            tag={<span style={{ color: "#296166" }}>Popular Programs for International Students</span>}
            title={
              <span style={{ color: "#296166" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }} className="lm-visa-wrap">
            ...
            <div style={{ position: "sticky", top: 100 }}>
              <DocsBox
                ...
                note={
                  <>
                    <strong style={{ color: C.navy }}>Processing Time:</strong> ~90 working days · No visa interview required
                    <br />
                    <br />
                    <strong style={{ color: C.navy }}>Note:</strong> All ages, study gaps, and most previously rejected cases are accepted. Contact our counsellors to confirm eligibility for your profile.
                    <br />
                    <br />
      ...
      <section style={{ background: C.white, padding: "100px 48px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SectionHead
            tag={<span style={{ color: "#296166" }}>Work Opportunities</span>}
            title={<span style={{ color: "#296166" }}>Work While You Study — and After</span>}
            sub={
              <span style={{ color: "#296166" }}>
      ...
      {/* <section style={{ background: C.cream, padding: "100px 48px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <SectionHead tag={<span style={{ color: "#296166" }}>FAQs</span>} title="Frequently Asked Questions — Study in Cyprus" center />
          <Reveal>
